  ...
  <body>
    ...
    <section class="py-5 mt-5 px-0">
        <div class="container-fluid p-0 m-0 row">
            ...
            <div class="col-lg-6 ml-auto text-center animate__animated animate__bounce animate_delay-2s">
                <img src="img/Pixel 3 XL (6) 1.png" class="img-fluid">
            </div>
        </div>

        <div class="row ml-auto">
            <div class="col-lg-4 ml-auto text-center animate__animated animate__fadeInDownBig animate_delay-2s">
                <img src="img/Pixel 3 XL (7) 2.png" class="img-fluid">
            </div>
            <div class="col-lg-4 ml-auto text-center animate__animated animate__fadeInRightBig animate_delay-2s">
